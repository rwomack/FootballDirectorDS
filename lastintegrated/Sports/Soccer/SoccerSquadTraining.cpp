...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
double CSquadTraining::Get5aSideHours()						
{ 
	return static_cast<double>(Get5aSidePercent()) * (static_cast<double>(GetTeamTrainingHours()) / 100); 
}
...
{ 
	double Hours = static_cast<double>(GetTeamTrainingHours()) / 100; 
