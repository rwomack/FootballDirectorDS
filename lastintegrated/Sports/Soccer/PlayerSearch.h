...
public:
    ...
    // Methods
	void					DoAddToList(const ushort _PlayerID, const ushort _ClubID, const uint _PlayerValue);
	...
	CNumericArray<ushort>&	GetPlayerClubNumberList();
...
private:
	...
	CNumericArray<ushort>	m_PlayerClubNumberList;
	byte					m_Flags;
