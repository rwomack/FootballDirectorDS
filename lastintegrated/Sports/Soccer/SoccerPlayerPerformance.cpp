...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
sbyte CPlayerPerformance::ConcededShot(sbyte _ShotSaveSkillDifference, byte _TheTime)
{
    sbyte Amount;
    switch(_ShotSaveSkillDifference)
	{
...
/*------------------------------------------------------------------------------
	Method:   	CSoccerPlayerPerformance::AttemptSave
	Access:    	public 
	Parameter: 	sbyte ShotSaveSkillDifference
	Parameter: 	byte TheTime
	Returns:   	sbyte
	...
	Purpose:
------------------------------------------------------------------------------*/
sbyte CPlayerPerformance::AttemptSave(sbyte _ShotSaveSkillDifference, byte _TheTime)
{
...
CPlayerPerformanceList::CPlayerPerformanceList()
{
	...
	{
		SetAt(ListPos, new CPlayerPerformance(0, MAXIMUMMATCHLENGTH));
	}
}
...
void CPlayerPerformanceList::Read(CDataFile* _pDataFile)
{
	...
	{
        SetAtGrow(ListPos, new CPlayerPerformance());
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CPlayerPerformanceList::ConcededShot(int _Who, sbyte _ShotSaveSkillDifference, byte _TheTime)
{
    AdjustDefencePerformance(GetAt(_Who)->ConcededShot(_ShotSaveSkillDifference, _TheTime), _TheTime);
}


/*------------------------------------------------------------------------------
	Method:   	CSoccerPlayerPerformanceList::AttemptSave
	Access:    	public 
	Parameter: 	int who
	Parameter: 	sbyte ShotSaveSkillDifference
	Parameter: 	byte when
	...
	Purpose:
------------------------------------------------------------------------------*/
void CPlayerPerformanceList::AttemptSave(int _Who, sbyte _ShotSaveSkillDifference, byte _TheTime)
{
    AdjustGoalPerformance(GetAt(_Who)->AttemptSave(_ShotSaveSkillDifference, _TheTime), _TheTime);
}
