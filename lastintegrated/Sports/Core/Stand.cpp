...
bool CStand::DoEndOfWeek(void)
{
 ...
 //---------------------------------------------------------------------------------------
void CStand::Write(FILE* File)
{
	ASSERT (File != NULL);
    m_Capacity.Write(File);
    //fwrite(&m_PriceBand, sizeof m_PriceBand, 1, File);
    m_Size.Write(File);
    m_Roof.Write(File);
    m_Seat.Write(File);
    m_Box.Write(File);
...
CStandList::~CStandList()
{
 ...
 //--------------------------------------------------------------------------
void CStandList::Create(FILE* File)
{
	SetSize(NUMBEROFSTANDS);
    m_Capacity.Read(File);
    for (uint32 ToFind = 0; ToFind < NUMBEROFSTANDS; ToFind ++)
	{
		SetAt(ToFind, new CStand(File));
	}
 }


 //---------------------------------------------------------------------------------------
void CStandList::Write(FILE* File)
{
	ASSERT (File != NULL);
    m_Capacity.Write(File);
 ...
 //---------------------------------------------------------------------------------------
void CStandList::Read(FILE* File)
{
	ASSERT (File != NULL);
    m_Capacity.Read(File);
