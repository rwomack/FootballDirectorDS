...
public:
	...
	ushort			GetVerticalScroll() const
	{
		return m_iVerticalScroll;
	}
	ushort			GetNumRowsOnScreen() const
	{
		return m_iNumRowsOnScreen;
	}
	ushort		GetCurSel() const
	{
		return m_nCurSel;
	}
	ushort		GetCurScreenSel() const
	{
	...
	void				SetNumRowsOnScreen(const ushort nRows)
	{
