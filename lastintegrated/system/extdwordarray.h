...
public:
	...
	void					SetAt(Int16 iPosition, UInt32 iValue)		{ ASSERT (iPosition < GetSize()); m_iList.setAt(iPosition, iValue); }
	...
	UInt32			GetAt(Int16 iPosition)						{ ASSERT (iPosition < GetSize()); return m_iList.elementAt(iPosition); }
