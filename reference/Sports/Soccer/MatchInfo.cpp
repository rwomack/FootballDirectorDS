...
CMatchInfo::CMatchInfo() 
	...
	, m_pCup(null)
	, m_pFixture(null)
	, m_HomeClubID(wNOTFOUND)
	, m_AwayClubID(wNOTFOUND)
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
CMatchInfo::CMatchInfo(const ushort _HomeClubID, const ushort _AwayClubID)
{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CMatchInfo::DoInitialiseClubs(const ushort _HomeClubID, const ushort _AwayClubID)
{
	m_HomeClubID = _HomeClubID;
    m_StadiumID = WorldData().GetClub(m_HomeClubID).GetStadiumID();
	m_AwayClubID = _AwayClubID;
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CMatchInfo::DoInitialiseFriendlyMatch(const ushort _HomeClubID, const ushort _AwayClubID)
{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CMatchInfo::DoInitialiseLeagueMatch(const ushort _HomeClubID, const ushort _AwayClubID, CDivision& _Division, CFixture* _Fixture)
{
...
{
	return WorldData().GetClub(m_AwayClubID).GetName();
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ushort CMatchInfo::GetHomeClubID() const
{ 
	return m_HomeClubID; 
}
...
{
	return WorldData().GetClub(m_HomeClubID).GetName();
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ushort CMatchInfo::GetAwayClubID() const
{ 
	return m_AwayClubID; 
}
...
{
	if (m_HomeClubID == NOCLUB || m_AwayClubID == NOCLUB)
	{
		// No opponent
		return null;
	}
	if (_TheClub == &WorldData().GetClub(m_HomeClubID))
	{
		return &WorldData().GetClub(m_AwayClubID);
	}
	return &WorldData().GetClub(m_HomeClubID);
}
...
{
	if (&WorldData().GetClub(m_HomeClubID) == _Club)
	{
		return true;
	}
	return false;
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CMatchInfo::SetCompetitionTitle(CString _Str)
{ 
	m_CompTitle = _Str; 
}
