...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const bool CPopularity::IsUserGoodEnoughToManageClub(const byte ManagerRating)
{
	return (m_MinimumManagerRatingToManageClub <=  ManagerRating);
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const byte	CPopularity::GetGoodSkill() const										
{ 
	return m_GoodSkill; 
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const byte	CPopularity::GetSackSkill() const										
{ 
	return m_SackSkill; 
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const byte	CPopularity::GetGoodPlayer() const									
{ 
	return m_GoodPlayer; 
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const double CPopularity::GetBoxPrice() const
{
	return m_BoxPrice;
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
bool CPopularity::IsPlayerSkillInRangeNonUserBid(const byte _Skill, int _DivisionStrength)
{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const uint CPopularity::RandomManagerWeeklyWage(const byte FinancialRatioPercentage)
{
    return (m_rangeManagerWeeklyWage.RandomAmount() / 100) * FinancialRatioPercentage;
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
const bool CPopularity::IsGoodClub()
{
...
CPopularityList::CPopularityList()
{
	...
	m_pList = new CPopularity[GetSize()];
...
/*------------------------------------------------------------------------------
	...
	Access:    	public 
	Parameter: 	const uint nAverageAttendance
	Returns:   	byte
	Qualifier: 	
	Purpose:
------------------------------------------------------------------------------*/
byte CPopularityList::DoCalculateID(const uint nAverageAttendance)
{
	byte bRet = 0;
    for (byte nListPos = CExtArray::GetUpperBound(); nListPos >= 0; nListPos--)
	{
		if (nAverageAttendance < m_pList[nListPos].GetMaximumAttendance())
		{
			bRet = nListPos;
			break;
		}
