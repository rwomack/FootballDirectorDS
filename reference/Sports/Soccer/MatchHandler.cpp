...
void CMatchHandler::DoMatch(CFixture* _Fixture, CCup* _Cup /*= null*/, CCupRound* _CupRound /*= null*/, CFixture* _LastFixture /*= null*/)
{
	...
	GetMatchPlay().DoMatch(_Fixture, _Cup, _CupRound, _LastFixture, GetMatchVars().GetMatchVars(HOME).GetClub().GetStadium()->GetName());
}
...
void CMatchHandler::DoDivisionMatch(CFixture* _Fixture, CDivision* _Division)
{
	...
	GetMatchVars().SetHomeAwayClubs(*_Fixture);
    GetMatchPlay().DoMatch(_Fixture, _Division, null, null, null, GetMatchVars().GetMatchVars(HOME).GetClub().GetStadium()->GetName());
}
