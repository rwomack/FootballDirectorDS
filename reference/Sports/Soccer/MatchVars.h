...
public:
	...
	void					DoInitialiseClubs(const byte _SubsSelect);
	...
	void					DoTakePlayerOff(byte _TheTime, eWhichTeam _Who, int _SquadNumber);
	void 					PlayerScoredGoal(eWhichTeam _WhichTeam, int _who, sbyte _ShotSaveSkillDifference, byte _TheTime);
	void 					PlayerConcededShot(eWhichTeam _WhichTeam, int _Who, sbyte _ShotSaveSkillDifference, byte _TheTime);
	...
	void					GoalkeeperAttemptSave(eWhichTeam _WhichTeam, int _Who, sbyte _ShotSaveSkillDifference, byte _TheTime);
	...
	CMatchVarsData&			GetMatchVars(eWhichTeam _Who);
