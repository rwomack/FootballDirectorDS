...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
short CContract::GetContractLength() const
{ 
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CContract::SetContractLength(const short _ContractLength)
{ 
	if (_ContractLength > 6)
	{
		int ab = 0;
	}
	EXT_ASSERT(_ContractLength < 10);
...
{ 
	m_ContractLength += _ContractLength; 
	EXT_ASSERT(m_ContractLength < 10);
}
