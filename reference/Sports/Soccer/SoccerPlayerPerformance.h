...
public:
	...
	sbyte 					AttemptSave(sbyte _ShotSaveSkillDifference, byte _TheTime);
	void DoClearSkillFrom(byte _TheTime);
	void DoClearSkillTo(byte _TheTime);
	sbyte					ConcededShot(sbyte _ShotSaveSkillDifference, byte _TheTime);
    sbyte                   DefendAttempt(byte ShotSaveSkillDifference, byte TheTime);
	byte					GetSkill(byte time);
	byte					GetOverallRating(int _PeriodLength);
...
public:
	...
	void 					AttemptSave(int _Who, sbyte _ShotSaveSkillDifference, byte _TheTime);
	...
	void					DoInitialiseExtraTime(byte _ExtraTimeLength);
	void 					ConcededShot(int _Who, sbyte _ShotSaveSkillDifference, byte _TheTime);
