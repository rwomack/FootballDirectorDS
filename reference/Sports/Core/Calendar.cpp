...
CCalendar::CCalendar(const CCalendar& SomeTime)
{
    ...
    m_JulianDate = SomeTime.m_JulianDate;
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
bool CCalendar::operator < (CCalendar Time)
{
	if (m_JulianDate < Time.GetDate())
	{
		return true;
	}
	else
...
/*------------------------------------------------------------------------------
	Method:   	CCalendar::SetMatchDayNumber
	Access:    	public 
...
{
	CDate t_Date(CDate::m_JulianDate);
