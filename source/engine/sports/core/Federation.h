...
public:
	...
	void DoListCountryEntrants(CActiveCountry& _Country, CNumericArray<ClubID>* _TheList);
	...
	bool					HasEnteredFederationCup(ClubID _ClubID);
	int						TotalCups();
#endif
...
public:
	...
	CFederation&			Find(const CString& _FedName);
