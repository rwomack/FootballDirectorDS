...
void CBaseCompetition::DoInitialiseFromResource(CBinaryReader& _Resource)
{
	...
	m_WinningClubID.id = _Resource.ReadUInt16();
	m_RunnersUpClubID.id = _Resource.ReadUInt16();
#ifdef NEWSPAPERON
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ClubID CBaseCompetition::GetWinningClubID() const
{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ClubID CBaseCompetition::GetRunnersUpClubID() const
{
...
void CBaseCompetition::Read(CDataFile* _pDataFile)
{
    ...
    _pDataFile->Read(&m_TitleID, sizeof(m_TitleID));
	_pDataFile->Read(&m_TransferDeadlineSystemID, sizeof(m_TransferDeadlineSystemID));
	_pDataFile->Read(&m_PercentageAwayGateReceipts, sizeof(m_PercentageAwayGateReceipts));
	_pDataFile->Read(&m_PercentageFAGateReceipts, sizeof(m_PercentageFAGateReceipts));
...
void CBaseCompetition::Write(CDataFile* _pDataFile)
{
    ...
    _pDataFile->Write(&m_TitleID, sizeof(m_TitleID));
	_pDataFile->Write(&m_TransferDeadlineSystemID, sizeof(m_TransferDeadlineSystemID));
	_pDataFile->Write(&m_PercentageAwayGateReceipts, sizeof(m_PercentageAwayGateReceipts));
	_pDataFile->Write(&m_PercentageFAGateReceipts, sizeof(m_PercentageFAGateReceipts));
...
/*------------------------------------------------------------------------------
	Method:   	CBaseCompetition::SetWinningClubID
	Access:    	public 
	...
	Purpose:
------------------------------------------------------------------------------*/
void CBaseCompetition::SetWinningClubID(const ClubID _ClubID)
{
...
/*------------------------------------------------------------------------------
	Method:   	CBaseCompetition::SetRunnersUpClubID
	Access:    	public 
	Parameter: 	const ClubID _ClubID
	Returns:   	void
	Qualifier: 	
	Purpose:
------------------------------------------------------------------------------*/
void CBaseCompetition::SetRunnersUpClubID(const ClubID _ClubID)
{
