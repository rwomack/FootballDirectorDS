...
#define __SOCCERDEFINES_H__
	...
	enum eNewsType
	{
		NEWSALL,
		NEWSTRANSFER,
		NEWSFEDERATIONHEADQUARTERS,
		NEWSCOUNTRYHEADQUARTERS,
		NEWSDISCIPLINE,
		NEWSINJURY,
		NEWSMANAGEMENT,
		NEWSCLUB,
	...
	const uint				CHANCESELLUNLISTEDPLAYER = 40;
	...
	const uint				MATCHCOMPETITIONTYPEBITS = 4 + 1;


#define MAXNUMPLAYERS 4300

//MAXNUMPLAYERS based on conservative basis of
//  1 Jul 2008 - 3640
//  10 Aug 2024 - 4121
//  9 Aug 2025 - 4135
...
struct ClubID
{
	...
	explicit ClubID(const ushort i) : id(i)
	{
	}

	bool operator==(const ClubID &rhs) const
	{
		return id == rhs.id;
	}
