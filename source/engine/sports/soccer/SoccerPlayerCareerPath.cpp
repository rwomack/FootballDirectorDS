...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
float CPlayerCareerPath::PositiveMultiplier(const byte _Age) const
{
  	return (float)m_Positive[DoCalculateWhichElementForAge(_Age)] / 100;
}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
float CPlayerCareerPath::NegativeMultiplier(const byte _Age) const
{
...
CPlayerCareerPathList::CPlayerCareerPathList()
{
	...
	m_pList = FD_ENGINE_NEW CPlayerCareerPath[CExtArray::GetSize()];
