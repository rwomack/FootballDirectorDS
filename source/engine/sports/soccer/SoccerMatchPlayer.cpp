...
void CSoccerMatchPlayer::IncShotsOffTarget()
{
 ...
 //-----------------------------------------------------------------------------------------------------
void CSoccerMatchPlayer::UpdateHowLongPlayed(CPlayerPerformance* pPtr)
{
	byte HowLong = pPtr->HowLongPlayed();
...
CSoccerMatchPlayerList::CSoccerMatchPlayerList()
{
	...
	{
        SetAt(num, FD_ENGINE_NEW CSoccerMatchPlayer());
    }
}
...
CSoccerMatchPlayerList::CSoccerMatchPlayerList(CClub* ClubPtr, int NumSubs)
{
	...
	{
        SetAt(num, FD_ENGINE_NEW CSoccerMatchPlayer(&ClubPtr->GetPlayer(num), num));
    }
	DoResetVariables();
}
