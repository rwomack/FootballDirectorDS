...
int CTactic::GetNumberOfPlayersAtPosition(const ePlayerPosition ePosition) const
{
	int iCount = 0;
	for (int i = 0; i < NUMBERPLAYERS; i++)
	{
		if (PlayerPosition(i) == ePosition)
			iCount++;
	}
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ushort CTactic::GetPlayerPositionX(ushort _PositionNum) const
{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ushort CTactic::GetPlayerPositionY(ushort _PositionNum) const
{
	EXT_ASSERT(_PositionNum < NUMBERPLAYERS);
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
ePlayerPosition CTactic::PlayerPosition(ushort _PlayerNum) const
{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
bool CTactic::IsDefender(int _PlayerNum) const
{
	EXT_ASSERT(_PlayerNum < NUMBERPLAYERS);
	bool bRet[] =
	{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
bool CTactic::IsMidfielder(int _PlayerNum) const
{
	EXT_ASSERT(_PlayerNum < NUMBERPLAYERS);
	bool bRet[] =
	{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
bool CTactic::IsAttacker(int _PlayerNum) const
{
	EXT_ASSERT(_PlayerNum < NUMBERPLAYERS);
	bool bRet[] =
	{
...
/*------------------------------------------------------------------------------
	...
	Purpose:
------------------------------------------------------------------------------*/
void CTacticList::SetTitle(const ushort Which, const CString &String)
{
...
void CTacticList::DoBuildTitleAndFamiliarityStrList(CTextSelector& _TextSelector)
{
	...
	{
    CString str = m_TacticList[nCount].TitleAndFamiliarityStr();
    _TextSelector.DoAddItem(str);
	}
