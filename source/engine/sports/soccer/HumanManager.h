...
public:
	...
	// Other methods
    CString					AgeStr();
	void					AddToNews(const CExtString &_Message, bool bUserRelated=false);
	...
	bool					HasRefusedFriendly(const ClubID _ClubID);
	bool					IsActive();
	...
	void					LeftClub();
	void					RefuseFriendly(const ClubID _ClubID);
...
public:
	...
	// Methods
	void					AddToNews(CActiveCountry& _Country, const CExtString &_Message, bool bUserRelated);
	bool					AnyActiveUsers();
